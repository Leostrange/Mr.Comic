...
interface FormatReader {
    ...
    /**
     * True when this reader exposes HTML/reflowable pages through [getHtmlPage].
     *
     * Archive readers use this to report delegated text books even when the outer file
     * extension is normally raster-oriented (for example ZIP/CBZ/RAR with cover images
     * plus a single EPUB/HTML/TXT entry).
     */
