...
internal fun decodeTextBytes(bytes: ByteArray): String {
    ...
    val decoded = SINGLE_BYTE_TEXT_CHARSETS
...
private fun repairCommonTextMojibake(text: String): String {
    ...
    val candidates = buildList {
        add(text)
        listOf("windows-1252", "windows-1251").forEach { charsetName ->
    ...
    return candidates
        ...
        ?.takeIf { scoreDecodedText(it, Charsets.UTF_8) > originalScore + 80 }
        ?: text
}
...
private fun looksLikeCommonMojibake(text: String): Boolean {
    ...
    return cyrillicLetters > 0 && mojibakePairs >= 3
}
