...
.method public constructor <init>(Landroidx/compose/foundation/gestures/ScrollingLogic;Landroidx/compose/foundation/gestures/Orientation;ZLandroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;Landroidx/compose/foundation/interaction/MutableInteractionSource;)V
    ...
    iput-object v2, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;

    .line 602
    move/from16 v3, p3

    iput-boolean v3, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->enabled:Z

    .line 603
    move-object/from16 v4, p4

    iput-object v4, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->nestedScrollDispatcher:Landroidx/compose/ui/input/nestedscroll/NestedScrollDispatcher;

    .line 604
    move-object/from16 v5, p5

    iput-object v5, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->interactionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;

    .line 606
    new-instance v6, Landroidx/compose/foundation/gestures/MouseWheelScrollNode;

    iget-object v7, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->scrollLogic:Landroidx/compose/foundation/gestures/ScrollingLogic;

    invoke-direct {v6, v7}, Landroidx/compose/foundation/gestures/MouseWheelScrollNode;-><init>(Landroidx/compose/foundation/gestures/ScrollingLogic;)V

    check-cast v6, Landroidx/compose/ui/node/DelegatableNode;

    invoke-virtual {v0, v6}, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->delegate(Landroidx/compose/ui/node/DelegatableNode;)Landroidx/compose/ui/node/DelegatableNode;

    .line 608
    new-instance v6, Landroidx/compose/foundation/gestures/ScrollDraggableState;

    iget-object v7, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->scrollLogic:Landroidx/compose/foundation/gestures/ScrollingLogic;

    invoke-direct {v6, v7}, Landroidx/compose/foundation/gestures/ScrollDraggableState;-><init>(Landroidx/compose/foundation/gestures/ScrollingLogic;)V

    iput-object v6, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->draggableState:Landroidx/compose/foundation/gestures/ScrollDraggableState;

    .line 609
    new-instance v6, Landroidx/compose/foundation/gestures/ScrollableGesturesNode$startDragImmediately$1;

    invoke-direct {v6, v0}, Landroidx/compose/foundation/gestures/ScrollableGesturesNode$startDragImmediately$1;-><init>(Landroidx/compose/foundation/gestures/ScrollableGesturesNode;)V

    check-cast v6, Lkotlin/jvm/functions/Function0;

    iput-object v6, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->startDragImmediately:Lkotlin/jvm/functions/Function0;

    .line 610
    new-instance v6, Landroidx/compose/foundation/gestures/ScrollableGesturesNode$onDragStopped$1;

    const/4 v7, 0x0

    invoke-direct {v6, v0, v7}, Landroidx/compose/foundation/gestures/ScrollableGesturesNode$onDragStopped$1;-><init>(Landroidx/compose/foundation/gestures/ScrollableGesturesNode;Lkotlin/coroutines/Continuation;)V

    check-cast v6, Lkotlin/jvm/functions/Function3;

    iput-object v6, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->onDragStopped:Lkotlin/jvm/functions/Function3;

    .line 616
    nop

    .line 618
    iget-object v6, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->draggableState:Landroidx/compose/foundation/gestures/ScrollDraggableState;

    .line 619
    iget-object v10, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;

    .line 620
    iget-boolean v11, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->enabled:Z

    .line 621
    iget-object v12, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->interactionSource:Landroidx/compose/foundation/interaction/MutableInteractionSource;

    .line 623
    iget-object v13, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->startDragImmediately:Lkotlin/jvm/functions/Function0;

    .line 624
    iget-object v15, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->onDragStopped:Lkotlin/jvm/functions/Function3;
    ...
    .line 617
    new-instance v17, Landroidx/compose/foundation/gestures/DraggableNode;
    ...
    invoke-direct/range {v7 .. v16}, Landroidx/compose/foundation/gestures/DraggableNode;-><init>(Landroidx/compose/foundation/gestures/DraggableState;Lkotlin/jvm/functions/Function1;Landroidx/compose/foundation/gestures/Orientation;ZLandroidx/compose/foundation/interaction/MutableInteractionSource;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function3;Lkotlin/jvm/functions/Function3;Z)V
    ...
    check-cast v6, Landroidx/compose/foundation/gestures/DraggableNode;

    iput-object v6, v0, Landroidx/compose/foundation/gestures/ScrollableGesturesNode;->draggableGesturesNode:Landroidx/compose/foundation/gestures/DraggableNode;
