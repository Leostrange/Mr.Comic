...
.method public constructor <init>(ZLandroidx/compose/material3/SheetValue;Lkotlin/jvm/functions/Function1;Z)V
    ...
    const-string/jumbo v1, "The initial value must not be set to PartiallyExpanded if skipPartiallyExpanded is set to true."
    ...
    .line 118
    .local v0, "$i$a$-require-SheetState$4":I
    nop

    .line 117
    .end local v0    # "$i$a$-require-SheetState$4":I
    new-instance v0, Ljava/lang/IllegalArgumentException;

    const-string/jumbo v1, "The initial value must not be set to Hidden if skipHiddenState is set to true."
    ...
    .line 267
    sget-object v0, Landroidx/compose/material3/AnchoredDraggableDefaults;->INSTANCE:Landroidx/compose/material3/AnchoredDraggableDefaults;

    invoke-virtual {v0}, Landroidx/compose/material3/AnchoredDraggableDefaults;->getAnimationSpec()Landroidx/compose/animation/core/SpringSpec;

    move-result-object v0

    .line 265
    new-instance v7, Landroidx/compose/material3/AnchoredDraggableState;
    ...
    invoke-direct {v1, p0}, Landroidx/compose/material3/SheetState$anchoredDraggableState$1;-><init>(Landroidx/compose/material3/SheetState;)V
    ...
    invoke-direct {v1, p0}, Landroidx/compose/material3/SheetState$anchoredDraggableState$2;-><init>(Landroidx/compose/material3/SheetState;)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/compose/material3/AnchoredDraggableState;-><init>(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Landroidx/compose/animation/core/AnimationSpec;Lkotlin/jvm/functions/Function1;)V

    iput-object v7, p0, Landroidx/compose/material3/SheetState;->anchoredDraggableState:Landroidx/compose/material3/AnchoredDraggableState;
...
.method public static final synthetic access$requireDensity(Landroidx/compose/material3/SheetState;)Landroidx/compose/ui/unit/Density;
    .locals 1
    .param p0, "$this"    # Landroidx/compose/material3/SheetState;
...
.method private final requireDensity()Landroidx/compose/ui/unit/Density;
    ...
    .line 277
    .local v0, "$i$a$-requireNotNull-SheetState$requireDensity$1":I
    nop

    .line 276
    .end local v0    # "$i$a$-requireNotNull-SheetState$requireDensity$1":I
    new-instance v0, Ljava/lang/IllegalArgumentException;

    const-string/jumbo v1, "SheetState did not have a density attached. Are you using SheetState with BottomSheetScaffold or ModalBottomSheet component?"
...
.method public final setAnchoredDraggableState$material3_release(Landroidx/compose/material3/AnchoredDraggableState;)V
    .locals 0
    .param p1, "<set-?>"    # Landroidx/compose/material3/AnchoredDraggableState;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/compose/material3/AnchoredDraggableState<",
