...
.method public static final DateRangeInputContent(Ljava/lang/Long;Ljava/lang/Long;Lkotlin/jvm/functions/Function2;Landroidx/compose/material3/CalendarModel;Lkotlin/ranges/IntRange;Landroidx/compose/material3/DatePickerFormatter;Landroidx/compose/material3/SelectableDates;Landroidx/compose/material3/DatePickerColors;Landroidx/compose/runtime/Composer;I)V
    ...
    .param p3, "calendarModel"    # Landroidx/compose/material3/CalendarModel;
    ...
    const-string v1, "C(DateRangeInputContent)P(6,5,3!1,7,2,4)42@1614L15,43@1656L87,46@1771L45,47@1851L44,48@1929L45,49@2003L50,50@2083L486,67@2782L2321:DateRangeInput.kt#uh7d8r"
    ...
    const-string/jumbo v8, "androidx.compose.material3.DateRangeInputContent (DateRangeInput.kt:40)"
    ...
    const-string v0, "CC(remember):DateRangeInput.kt#9igjgp"
    ...
    .line 45
    .local v4, "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$dateInputFormat$1":I
    ...
    .line 124
    .end local v4    # "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$dateInputFormat$1":I
    nop
    ...
    .line 128
    .local v5, "$i$f$getDateInputInvalidForPattern-adMyvUU":I
    sget v16, Landroidx/compose/material3/R$string;->m3c_date_input_invalid_for_pattern:I
    ...
    .end local v5    # "$i$f$getDateInputInvalidForPattern-adMyvUU":I
    const/4 v5, 0x0

    invoke-static {v4, v9, v5}, Landroidx/compose/material3/Strings_androidKt;->getString-NWtq2-8(ILandroidx/compose/runtime/Composer;I)Ljava/lang/String;
    ...
    .restart local v4    # "this_$iv":Landroidx/compose/material3/Strings$Companion;
    const/16 v16, 0x0

    .line 129
    .local v16, "$i$f$getDateInputInvalidYearRange-adMyvUU":I
    sget v17, Landroidx/compose/material3/R$string;->m3c_date_input_invalid_year_range:I

    invoke-static/range {v17 .. v17}, Landroidx/compose/material3/Strings;->constructor-impl(I)I

    move-result v4

    .line 48
    .end local v4    # "this_$iv":Landroidx/compose/material3/Strings$Companion;
    .end local v16    # "$i$f$getDateInputInvalidYearRange-adMyvUU":I
    invoke-static {v4, v9, v5}, Landroidx/compose/material3/Strings_androidKt;->getString-NWtq2-8(ILandroidx/compose/runtime/Composer;I)Ljava/lang/String;
    ...
    .line 130
    .local v16, "$i$f$getDateInputInvalidNotAllowed-adMyvUU":I
    sget v17, Landroidx/compose/material3/R$string;->m3c_date_input_invalid_not_allowed:I
    ...
    .line 49
    .end local v4    # "this_$iv":Landroidx/compose/material3/Strings$Companion;
    .end local v16    # "$i$f$getDateInputInvalidNotAllowed-adMyvUU":I
    invoke-static {v4, v9, v5}, Landroidx/compose/material3/Strings_androidKt;->getString-NWtq2-8(ILandroidx/compose/runtime/Composer;I)Ljava/lang/String;
    ...
    .line 131
    .local v16, "$i$f$getDateRangeInputInvalidRangeInput-adMyvUU":I
    sget v17, Landroidx/compose/material3/R$string;->m3c_date_range_input_invalid_range_input:I
    ...
    .line 50
    .end local v4    # "this_$iv":Landroidx/compose/material3/Strings$Companion;
    .end local v16    # "$i$f$getDateRangeInputInvalidRangeInput-adMyvUU":I
    invoke-static {v4, v9, v5}, Landroidx/compose/material3/Strings_androidKt;->getString-NWtq2-8(ILandroidx/compose/runtime/Composer;I)Ljava/lang/String;
    ...
    .line 52
    .local v3, "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$dateInputValidator$1":I
    new-instance v38, Landroidx/compose/material3/DateInputValidator;
    ...
    .line 134
    .end local v3    # "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$dateInputValidator$1":I
    ...
    .local v2, "$this$DateRangeInputContent_u24lambda_u242":Landroidx/compose/material3/DateInputValidator;
    const/4 v3, 0x0

    .line 65
    .local v3, "$i$a$-apply-DateRangeInputKt$DateRangeInputContent$1":I
    invoke-virtual {v2, v14}, Landroidx/compose/material3/DateInputValidator;->setCurrentStartDateMillis$material3_release(Ljava/lang/Long;)V

    .line 66
    invoke-virtual {v2, v15}, Landroidx/compose/material3/DateInputValidator;->setCurrentEndDateMillis$material3_release(Ljava/lang/Long;)V

    .line 67
    nop

    .line 64
    .end local v2    # "$this$DateRangeInputContent_u24lambda_u242":Landroidx/compose/material3/DateInputValidator;
    .end local v3    # "$i$a$-apply-DateRangeInputKt$DateRangeInputContent$1":I
    nop
    ...
    invoke-static {v12, v5, v9, v2}, Landroidx/compose/foundation/layout/RowKt;->rowMeasurePolicy(Landroidx/compose/foundation/layout/Arrangement$Horizontal;Landroidx/compose/ui/Alignment$Vertical;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-interface {v5, v2, v9, v3}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v4, "C72@3043L56,84@3623L203,73@3108L955,94@4091L54,106@4663L199,95@4154L943:DateRangeInput.kt#uh7d8r"
    ...
    invoke-virtual {v8}, Landroidx/compose/material3/DateInputFormat;->getPatternWithDelimiters()Ljava/lang/String;
    ...
    .line 172
    .local v43, "$i$f$getDateRangePickerStartHeadline-adMyvUU":I
    sget v44, Landroidx/compose/material3/R$string;->m3c_date_range_picker_start_headline:I

    invoke-static/range {v44 .. v44}, Landroidx/compose/material3/Strings;->constructor-impl(I)I

    move-result v2

    .line 73
    .end local v2    # "this_$iv":Landroidx/compose/material3/Strings$Companion;
    .end local v43    # "$i$f$getDateRangePickerStartHeadline-adMyvUU":I
    move-object/from16 v48, v8

    const/4 v8, 0x0

    .end local v8    # "dateInputFormat":Landroidx/compose/material3/DateInputFormat;
    .local v48, "dateInputFormat":Landroidx/compose/material3/DateInputFormat;
    invoke-static {v2, v3, v8}, Landroidx/compose/material3/Strings_androidKt;->getString-NWtq2-8(ILandroidx/compose/runtime/Composer;I)Ljava/lang/String;

    move-result-object v2

    .line 75
    .local v2, "startRangeText":Ljava/lang/String;
    ...
    .line 85
    .local v0, "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$2$1":I
    move/from16 v50, v0

    .end local v0    # "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$2$1":I
    .local v50, "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$2$1":I
    new-instance v0, Landroidx/compose/material3/DateRangeInputKt$DateRangeInputContent$2$1$1;

    invoke-direct {v0, v13, v15}, Landroidx/compose/material3/DateRangeInputKt$DateRangeInputContent$2$1$1;-><init>(Lkotlin/jvm/functions/Function2;Ljava/lang/Long;)V

    check-cast v0, Lkotlin/jvm/functions/Function1;

    .line 175
    .end local v50    # "$i$a$-cache-DateRangeInputKt$DateRangeInputContent$2$1":I
    nop
    ...
    invoke-direct {v0, v2, v4}, Landroidx/compose/material3/DateRangeInputKt$DateRangeInputContent$2$2;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v4}, Landroidx/compose/material3/DateRangeInputKt$DateRangeInputContent$2$3;-><init>(Ljava/lang/String;)V

    move-object/from16 p8, v2

    .end local v2    # "startRangeText":Ljava/lang/String;
    .local p8, "startRangeText":Ljava/lang/String;
    const v2, 0x27a94eeb

    invoke-static {v3, v2, v8, v0}, Landroidx/compose/runtime/internal/ComposableLambdaKt;->composableLambda(Landroidx/compose/runtime/Composer;IZLjava/lang/Object;)Landroidx/compose/runtime/internal/ComposableLambda;
    ...
    .end local p8    # "startRangeText":Ljava/lang/String;
    .local v31, "startRangeText":Ljava/lang/String;
    move-object v2, v5
    ...
    .end local v48    # "dateInputFormat":Landroidx/compose/material3/DateInputFormat;
    .local v29, "dateInputFormat":Landroidx/compose/material3/DateInputFormat;
    .local v36, "$dirty":I
    ...
    .line 179
    .local v1, "$i$f$getDateRangePickerEndHeadline-adMyvUU":I
    ...
    .end local v1    # "$i$f$getDateRangePickerEndHeadline-adMyvUU":I
    ...
    invoke-direct {v8, v11, v15}, Landroidx/compose/material3/DateRangeInputKt$DateRangeInputContent$2$4$1;-><init>(Lkotlin/jvm/functions/Function2;Ljava/lang/Long;)V
    ...
    .local v47, "pattern":Ljava/lang/String;
    move-object/from16 v10, p7
    ...
    .local v48, "endRangeText":Ljava/lang/String;
    move/from16 v12, v36
    ...
    .line 117
    .end local v31    # "startRangeText":Ljava/lang/String;
    .end local v47    # "pattern":Ljava/lang/String;
    .end local v48    # "endRangeText":Ljava/lang/String;
    nop
    ...
    .end local v29    # "dateInputFormat":Landroidx/compose/material3/DateInputFormat;
