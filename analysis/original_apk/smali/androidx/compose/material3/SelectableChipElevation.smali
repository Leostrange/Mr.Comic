...
.method private final animateElevation(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    const-string v2, "C(animateElevation)2260@108278L46,2261@108356L47,2262@108446L1482,2262@108412L1516,2322@110431L51,2324@110515L466,2324@110492L489:Chip.kt#uh7d8r"
    ...
    const-string/jumbo v3, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:2259)"
    ...
    .local v13, "interactions":Landroidx/compose/runtime/snapshots/SnapshotStateList;
    ...
    .local v15, "lastInteraction$delegate":Landroidx/compose/runtime/MutableState;
    invoke-interface/range {p3 .. p3}, Landroidx/compose/runtime/Composer;->endReplaceableGroup()V
    ...
    invoke-direct {v12, v9, v13, v14}, Landroidx/compose/material3/SelectableChipElevation$animateElevation$1$1;-><init>(Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/snapshots/SnapshotStateList;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {v9, v3, v10, v2}, Landroidx/compose/runtime/EffectsKt;->LaunchedEffect(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;I)V
    ...
    .line 2312
    iget v2, v0, Landroidx/compose/material3/SelectableChipElevation;->disabledElevation:F
    ...
    .line 2315
    instance-of v2, v12, Landroidx/compose/foundation/interaction/PressInteraction$Press;

    if-eqz v2, :cond_9

    iget v2, v0, Landroidx/compose/material3/SelectableChipElevation;->pressedElevation:F

    goto :goto_5

    .line 2316
    :cond_9
    instance-of v2, v12, Landroidx/compose/foundation/interaction/HoverInteraction$Enter;

    if-eqz v2, :cond_a

    iget v2, v0, Landroidx/compose/material3/SelectableChipElevation;->hoveredElevation:F

    goto :goto_5

    .line 2317
    :cond_a
    instance-of v2, v12, Landroidx/compose/foundation/interaction/FocusInteraction$Focus;

    if-eqz v2, :cond_b

    iget v2, v0, Landroidx/compose/material3/SelectableChipElevation;->focusedElevation:F

    goto :goto_5

    .line 2318
    :cond_b
    instance-of v2, v12, Landroidx/compose/foundation/interaction/DragInteraction$Start;

    if-eqz v2, :cond_c

    iget v2, v0, Landroidx/compose/material3/SelectableChipElevation;->draggedElevation:F

    goto :goto_5

    .line 2319
    :cond_c
    iget v2, v0, Landroidx/compose/material3/SelectableChipElevation;->elevation:F
...
.method public final shadowElevation$material3_release(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    const-string v1, "C(shadowElevation)2252@108029L74:Chip.kt#uh7d8r"
