...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-wide v2, p0, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;->$it:J

    invoke-direct {v0, v1, v2, v3, p2}, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;-><init>(Landroidx/compose/material3/ClockDialNode;JLkotlin/coroutines/Continuation;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;
    .local p1, "$result":Ljava/lang/Object;
    invoke-static {p1}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto :goto_0

    .end local v0    # "this":Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;
    ...
    .local v1, "this":Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;->this$0:Landroidx/compose/material3/ClockDialNode;
    ...
    iget-wide v4, v1, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;->$it:J

    invoke-static {v4, v5}, Landroidx/compose/ui/geometry/Offset;->getX-impl(J)F

    move-result v4

    iget-wide v5, v1, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;->$it:J
    ...
    invoke-static {v2}, Landroidx/compose/material3/ClockDialNode;->access$getMaxDist(Landroidx/compose/material3/ClockDialNode;)F

    move-result v6

    iget-object v2, v1, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;->this$0:Landroidx/compose/material3/ClockDialNode;

    invoke-static {v2}, Landroidx/compose/material3/ClockDialNode;->access$getAutoSwitchToMinute$p(Landroidx/compose/material3/ClockDialNode;)Z
    ...
    iput v2, v1, Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;->label:I
    ...
    .end local v1    # "this":Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;
    .restart local v0    # "this":Landroidx/compose/material3/ClockDialNode$pointerInputTapNode$1$2$1;
    :goto_0
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
