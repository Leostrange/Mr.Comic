...
.method private final animateElevation(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    const-string v1, "C(animateElevation)663@30130L46,664@30219L1482,664@30185L1516,725@32263L51,727@32347L888,727@32324L911:Card.kt#uh7d8r"
    ...
    const-string/jumbo v2, "androidx.compose.material3.CardElevation.animateElevation (Card.kt:662)"
    ...
    invoke-direct {v15, v9, v13, v3}, Landroidx/compose/material3/CardElevation$animateElevation$1$1;-><init>(Landroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/snapshots/SnapshotStateList;Lkotlin/coroutines/Continuation;)V
    ...
    .line 715
    iget v1, v7, Landroidx/compose/material3/CardElevation;->disabledElevation:F
    ...
    .line 718
    instance-of v1, v14, Landroidx/compose/foundation/interaction/PressInteraction$Press;

    if-eqz v1, :cond_8

    iget v1, v7, Landroidx/compose/material3/CardElevation;->pressedElevation:F

    goto :goto_4

    .line 719
    :cond_8
    instance-of v1, v14, Landroidx/compose/foundation/interaction/HoverInteraction$Enter;

    if-eqz v1, :cond_9

    iget v1, v7, Landroidx/compose/material3/CardElevation;->hoveredElevation:F

    goto :goto_4

    .line 720
    :cond_9
    instance-of v1, v14, Landroidx/compose/foundation/interaction/FocusInteraction$Focus;

    if-eqz v1, :cond_a

    iget v1, v7, Landroidx/compose/material3/CardElevation;->focusedElevation:F

    goto :goto_4

    .line 721
    :cond_a
    instance-of v1, v14, Landroidx/compose/foundation/interaction/DragInteraction$Start;

    if-eqz v1, :cond_b

    iget v1, v7, Landroidx/compose/material3/CardElevation;->draggedElevation:F

    goto :goto_4

    .line 722
    :cond_b
    iget v1, v7, Landroidx/compose/material3/CardElevation;->defaultElevation:F
...
.method public final shadowElevation$material3_release(ZLandroidx/compose/foundation/interaction/InteractionSource;Landroidx/compose/runtime/Composer;I)Landroidx/compose/runtime/State;
    ...
    const-string v1, "C(shadowElevation)655@29881L74:Card.kt#uh7d8r"
...
.method public final tonalElevation-u2uoSUM$material3_release(Z)F
    ...
    :cond_0
    iget v0, p0, Landroidx/compose/material3/CardElevation;->disabledElevation:F
