...
# direct methods
.method public static synthetic $r8$lambda$tsKhgFF-rsSs5w6QKXXeuy8TqCs(Lcoil/compose/AsyncImagePainter$State;)Lcoil/compose/AsyncImagePainter$State;
    .locals 0
...
.method public onRemembered()V
    ...
    .line 288
    .local v2, "$i$a$-trace-AsyncImagePainter$onRemembered$1":I
    :try_start_0
    ...
    iput-object v5, p0, Lcoil/compose/AsyncImagePainter;->rememberScope:Lkotlinx/coroutines/CoroutineScope;

    .line 295
    iget-object v6, p0, Lcoil/compose/AsyncImagePainter;->_painter:Landroidx/compose/ui/graphics/painter/Painter;
    ...
    .line 298
    :cond_1
    iget-boolean v6, p0, Lcoil/compose/AsyncImagePainter;->isPreview:Z
    ...
    invoke-static {v6, v4, v3, v4}, Lcoil/request/ImageRequest;->newBuilder$default(Lcoil/request/ImageRequest;Landroid/content/Context;ILjava/lang/Object;)Lcoil/request/ImageRequest$Builder;
    ...
    invoke-interface {v6}, Lcoil/ImageLoader;->getDefaults()Lcoil/request/DefaultRequestOptions;

    move-result-object v6

    invoke-virtual {v3, v6}, Lcoil/request/ImageRequest$Builder;->defaults(Lcoil/request/DefaultRequestOptions;)Lcoil/request/ImageRequest$Builder;
    ...
    :cond_2
    invoke-direct {v6, v4}, Lcoil/compose/AsyncImagePainter$State$Loading;-><init>(Landroidx/compose/ui/graphics/painter/Painter;)V

    check-cast v6, Lcoil/compose/AsyncImagePainter$State;

    invoke-direct {p0, v6}, Lcoil/compose/AsyncImagePainter;->updateState(Lcoil/compose/AsyncImagePainter$State;)V
    ...
    .end local v2    # "$i$a$-trace-AsyncImagePainter$onRemembered$1":I
