...
public class VersionInfo {
    ...
    protected static VersionInfo fromMap(String str, Map<?, ?> map, ClassLoader classLoader) {
        ...
        if (map != null) {
            ...
            String str9 = (str8 == null || (str8.length() > 0 && !str8.equals("${pom.version}"))) ? str8 : null;
            String str10 = (String) map.get(PROPERTY_TIMESTAMP);
            if (str10 == null || (str10.length() > 0 && !str10.equals("${mvn.timestamp}"))) {
                str2 = str10;
                str3 = str9;
                str4 = str7;
            } else {
