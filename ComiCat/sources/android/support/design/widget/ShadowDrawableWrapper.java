...
class ShadowDrawableWrapper extends cz {
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.mShadowStartColor = resources.getColor(a.c.shadow_start_color);
        this.mShadowMiddleColor = resources.getColor(a.c.shadow_mid_color);
        this.mShadowEndColor = resources.getColor(a.c.shadow_end_color);
    ...
    private void buildShadowCorners() {
        ...
        if (f > 0.0f) {
            ...
            this.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, f, new int[]{0, this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, f2, f2 + ((SHADOW_BOTTOM_SCALE - f2) / 2.0f), 1.0f}, Shader.TileMode.CLAMP));
        }
