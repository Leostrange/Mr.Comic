...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, cv.k.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(cv.k.ActionBarLayout_android_layout_gravity, 0);
