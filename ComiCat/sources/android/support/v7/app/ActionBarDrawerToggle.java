...
public class ActionBarDrawerToggle implements DrawerLayout.f {
    ...
    static class DrawerArrowDrawableToggle extends DrawerArrowDrawable implements DrawerToggle {
        ...
        public boolean isLayoutRtl() {
            return bh.h(this.mActivity.getWindow().getDecorView()) == 1;
        }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                setActionBarUpIndicator((Drawable) this.mSlider, this.mDrawerLayout.b() ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
            } else {
