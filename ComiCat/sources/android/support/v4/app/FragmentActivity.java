...
public class FragmentActivity extends Activity {
    ...
    aj<String, LoaderManagerImpl> mAllLoaderManagers;
    ...
    static final class NonConfigurationInstances {
        Object activity;
        aj<String, Object> children;
        Object custom;
        ArrayList<Fragment> fragments;
        aj<String, LoaderManagerImpl> loaders;
    ...
    public LoaderManagerImpl getLoaderManager(String str, boolean z, boolean z2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = new aj<>();
        }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            for (int i = size - 1; i >= 0; i--) {
                loaderManagerImplArr[i] = this.mAllLoaderManagers.c(i);
            }
            z = false;
