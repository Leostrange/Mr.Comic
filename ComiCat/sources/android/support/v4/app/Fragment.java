...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    private static final aj<String, Class<?>> sClassMap = new aj<>();
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        ar.a(cloneInContext, this.mChildFragmentManager.getLayoutInflaterFactory());
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            ...
            this.mChildFragmentManager.restoreAllState(parcelable, (ArrayList<Fragment>) null);
            this.mChildFragmentManager.dispatchCreate();
        }
    }
