...
public class ActionBarDrawerToggle implements DrawerLayout.f {
    ...
    class SlideDrawable extends InsetDrawable implements Drawable.Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            boolean z = bh.h(this.this$0.mActivity.getWindow().getDecorView()) == 1;
            if (z) {
                i = -1;
            }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mDrawerImage = e.getDrawable(activity, i);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = e.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
    ...
    public void setDrawerIndicatorEnabled(boolean z) {
        if (z != this.mDrawerIndicatorEnabled) {
            if (z) {
                setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.b() ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
            } else {
    ...
    public void setHomeAsUpIndicator(int i) {
        ...
        if (i != 0) {
            drawable = e.getDrawable(this.mActivity, i);
        }
