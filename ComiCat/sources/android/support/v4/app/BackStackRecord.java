...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, Runnable {
    ...
    public class TransitionState {
        ...
        public ab<String, String> nameOverrides = new ab<>();
    ...
    public void callSharedElementEnd(TransitionState transitionState, Fragment fragment, Fragment fragment2, boolean z, ab<String, View> abVar) {
        SharedElementCallback sharedElementCallback = z ? fragment2.mEnterTransitionCallback : fragment.mEnterTransitionCallback;
        if (sharedElementCallback != null) {
            sharedElementCallback.onSharedElementEnd(new ArrayList(abVar.keySet()), new ArrayList(abVar.values()), (List<View>) null);
        }
    }

    private static Object captureExitingViews(Object obj, Fragment fragment, ArrayList<View> arrayList, ab<String, View> abVar, View view) {
        return obj != null ? FragmentTransitionCompat21.captureExitingViews(obj, fragment.getView(), arrayList, abVar, view) : obj;
    }
    ...
    private boolean configureTransitions(int i, TransitionState transitionState, boolean z, SparseArray<Fragment> sparseArray, SparseArray<Fragment> sparseArray2) {
        ...
        ab<String, View> abVar = null;
        ArrayList arrayList = new ArrayList();
        if (sharedElementTransition != null) {
            abVar = remapSharedElements(transitionState, fragment2, z);
            arrayList.add(transitionState.nonExistentView);
            arrayList.addAll(abVar.values());
            SharedElementCallback sharedElementCallback = z ? fragment2.mEnterTransitionCallback : fragment.mEnterTransitionCallback;
            if (sharedElementCallback != null) {
                sharedElementCallback.onSharedElementStart(new ArrayList(abVar.keySet()), new ArrayList(abVar.values()), (List<View>) null);
            }
        }
        ArrayList arrayList2 = new ArrayList();
        Object captureExitingViews = captureExitingViews(exitTransition, fragment2, arrayList2, abVar, transitionState.nonExistentView);
        if (!(this.mSharedElementTargetNames == null || abVar == null || (view = abVar.get(this.mSharedElementTargetNames.get(0))) == null)) {
        ...
        if (mergeTransitions != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, viewGroup, r15, transitionState.nonExistentView, transitionState.enteringEpicenterView, transitionState.nameOverrides, arrayList3, abVar2, arrayList);
            ...
            FragmentTransitionCompat21.cleanupTransitions(viewGroup, transitionState.nonExistentView, enterTransition, arrayList3, captureExitingViews, arrayList2, sharedElementTransition, arrayList, mergeTransitions, transitionState.hiddenFragmentViews, abVar2);
        }
        if (mergeTransitions != null) {
            return true;
        }
    ...
    private ab<String, View> mapEnteringSharedElements(TransitionState transitionState, Fragment fragment, boolean z) {
        ab<String, View> abVar = new ab<>();
        View view = fragment.getView();
        if (view == null || this.mSharedElementSourceNames == null) {
            return abVar;
        }
        FragmentTransitionCompat21.findNamedViews(abVar, view);
        if (z) {
            return remapNames(this.mSharedElementSourceNames, this.mSharedElementTargetNames, abVar);
        }
        ag.a(abVar, (Collection<?>) this.mSharedElementTargetNames);
        return abVar;
    }

    /* access modifiers changed from: private */
    public ab<String, View> mapSharedElementsIn(TransitionState transitionState, boolean z, Fragment fragment) {
        ab<String, View> mapEnteringSharedElements = mapEnteringSharedElements(transitionState, fragment, z);
        if (z) {
    ...
    private void prepareSharedElementTransition(TransitionState transitionState, View view, Object obj, Fragment fragment, Fragment fragment2, boolean z, ArrayList<View> arrayList) {
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                ...
                arrayList2.clear();
                ab access$000 = BackStackRecord.this.mapSharedElementsIn(transitionState2, z2, fragment3);
    ...
    private static ab<String, View> remapNames(ArrayList<String> arrayList, ArrayList<String> arrayList2, ab<String, View> abVar) {
        if (abVar.isEmpty()) {
            return abVar;
        }
        ab<String, View> abVar2 = new ab<>();
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            View view = abVar.get(arrayList.get(i));
            if (view != null) {
                abVar2.put(arrayList2.get(i), view);
            }
        }
        return abVar2;
    }

    private ab<String, View> remapSharedElements(TransitionState transitionState, Fragment fragment, boolean z) {
        ab<String, View> abVar = new ab<>();
        if (this.mSharedElementSourceNames != null) {
            FragmentTransitionCompat21.findNamedViews(abVar, fragment.getView());
            if (z) {
                ag.a(abVar, (Collection<?>) this.mSharedElementTargetNames);
            } else {
                abVar = remapNames(this.mSharedElementSourceNames, this.mSharedElementTargetNames, abVar);
            }
        }
        if (z) {
            if (fragment.mEnterTransitionCallback != null) {
                fragment.mEnterTransitionCallback.onMapSharedElements(this.mSharedElementTargetNames, abVar);
            }
            setBackNameOverrides(transitionState, abVar, SUPPORTS_TRANSITIONS);
        } else {
            if (fragment.mExitTransitionCallback != null) {
                fragment.mExitTransitionCallback.onMapSharedElements(this.mSharedElementTargetNames, abVar);
            }
            setNameOverrides(transitionState, abVar, (boolean) SUPPORTS_TRANSITIONS);
        }
        return abVar;
    }

    private void setBackNameOverrides(TransitionState transitionState, ab<String, View> abVar, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            View view = abVar.get(this.mSharedElementTargetNames.get(i));
            if (view != null) {
    ...
    /* access modifiers changed from: private */
    public void setEpicenterIn(ab<String, View> abVar, TransitionState transitionState) {
        View view;
        if (this.mSharedElementTargetNames != null && !abVar.isEmpty() && (view = abVar.get(this.mSharedElementTargetNames.get(0))) != null) {
    ...
    private static void setNameOverride(ab<String, String> abVar, String str, String str2) {
        if (str != null && str2 != null && !str.equals(str2)) {
            for (int i = 0; i < abVar.size(); i++) {
                if (str.equals(abVar.c(i))) {
                    abVar.a(i, str2);
                    return;
                }
            }
    ...
    private void setNameOverrides(TransitionState transitionState, ab<String, View> abVar, boolean z) {
        int size = abVar.size();
        for (int i = 0; i < size; i++) {
            String b = abVar.b(i);
            String transitionName = FragmentTransitionCompat21.getTransitionName(abVar.c(i));
            if (z) {
                setNameOverride(transitionState.nameOverrides, b, transitionName);
            } else {
                setNameOverride(transitionState.nameOverrides, transitionName, b);
            }
        }
    }
    ...
    public final int commitInternal(boolean z) {
        ...
        if (FragmentManagerImpl.DEBUG) {
            ...
            dump("  ", (FileDescriptor) null, new PrintWriter(new ae(TAG)), (String[]) null);
        }
                    ...
                    case 2:
                        ...
                        if (this.mManager.mAdded != null) {
                            ...
                            for (int i5 = 0; i5 < this.mManager.mAdded.size(); i5++) {
                                Fragment fragment4 = this.mManager.mAdded.get(i5);
                                if (FragmentManagerImpl.DEBUG) {
