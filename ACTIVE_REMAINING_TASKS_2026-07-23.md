...
- Остаток 4.1: Settings-контроллеры для translation flows и `SettingsViewModelFlows.kt` (582 строки, flow-композиция uiState); Library — вынос `observeAudiobooks`/audiobook-операций в контроллер и ревизия оставшихся extension-файлов.
