...
class DefaultComicTranslationEngine @Inject constructor(
    ...
    private suspend fun translateSingleBlock(
        ...
        suspend fun tryOffline(): Result<io.leostrange.mrcomic.core.model.TranslationResult> {
        ...
        suspend fun tryOnline(): Result<io.leostrange.mrcomic.core.model.TranslationResult> {
