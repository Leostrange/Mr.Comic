...
class SafeLlmExplainEngine @Inject constructor(
    ...
    private suspend fun resolveLocalTranslation(
        ...
        return when (
            val result = offlineTranslationEngine.translate(
                io.leostrange.mrcomic.core.model.TranslationRequest(
    ...
    private fun localizedSourceContext(
        ...
        io.leostrange.mrcomic.core.model.TranslationSourceType.COMIC_BLOCK -> when (language) {
        ...
        io.leostrange.mrcomic.core.model.TranslationSourceType.OCR_TEXT -> when (language) {
        ...
        io.leostrange.mrcomic.core.model.TranslationSourceType.BOOK_TEXT -> when (language) {
