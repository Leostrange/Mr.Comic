...
import com.example.feature.settings.ui.CloudSyncSection
...
fun SettingsScreen(
    ...
    val uiState by viewModel.uiState.collectAsState()
        ...
        var availableBackups by remember { mutableStateOf<List<String>>(emptyList()) }
    ...
    Scaffold(topBar = { 
        ...
        Column(
            ...
            // Cloud Sync Section
            CloudSyncSection(
                selectedCloudProvider = uiState.selectedCloudProvider,
                googleDriveAuthenticated = uiState.googleDriveAuthenticated,
                oneDriveAuthenticated = uiState.oneDriveAuthenticated,
                lastSyncTime = uiState.lastSyncTime,
                syncProgress = uiState.syncProgress,
                syncMessage = uiState.syncMessage,
                syncStatus = uiState.syncStatus,
                onProviderSelected = viewModel::selectCloudProvider,
                onSignIn = viewModel::signInToCloudProvider,
                onSignOut = viewModel::signOutFromCloudProvider,
        ...
        RestoreBackupDialog(
            ...
            availableBackups = availableBackups,
                onSelectBackup = { backup ->
                    ...
                    viewModel.restoreLocalBackup(backup)
                },
            onDismiss = {
                showRestoreDialog = false
            }
        ...
        // Загружаем список доступных бэкапов при открытии диалога восстановления
