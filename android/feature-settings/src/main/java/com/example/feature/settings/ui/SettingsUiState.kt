...
data class SettingsUiState(
    ...
    // Cloud Sync Settings
    val selectedCloudProvider: String? = null, // "google_drive" | "one_drive" | null
    val googleDriveAuthenticated: Boolean = false,
    val oneDriveAuthenticated: Boolean = false,
    val lastSyncTime: Long? = null,
    val syncProgress: Float = 0.0f,
    val syncMessage: String = "",
    val syncStatus: String = "IDLE" // IDLE | SYNCING | ERROR | SUCCESS
)
