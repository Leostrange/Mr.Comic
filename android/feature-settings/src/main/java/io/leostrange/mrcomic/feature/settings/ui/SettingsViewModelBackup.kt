// Phase U (2026-08-04):
// backup/restore helpers, export/import, cache management
...
import java.util.Locale
    ...
    internal suspend fun SettingsViewModel.buildBackupJson(
        comics: List<io.leostrange.mrcomic.core.model.Comic>,
    ...
    internal suspend fun SettingsViewModel.exportPreferencesJson(): JSONObject {
    ...
    internal fun SettingsViewModel.serializePreferenceValue(value: Any): JSONObject = JSONObject().apply {
        when (value) {
            is Boolean -> {
                put("type", "boolean")
                put("value", value)
    ...
    internal fun SettingsViewModel.parseComicBackupEntry(entry: JSONObject): Comic? {
    ...
    internal fun SettingsViewModel.resolveBackupSourcePath(comic: Comic): String {
    ...
    internal fun SettingsViewModel.parseBackupComicFormat(raw: String, path: String): ComicFormat {
    ...
    internal fun SettingsViewModel.deriveBackupTitle(path: String): String {
    ...
    internal fun SettingsViewModel.parseQuoteBackupEntry(entry: JSONObject): SavedQuote? {
    ...
    internal suspend fun SettingsViewModel.restorePreferencesFromBackup(preferencesJson: JSONObject?): Int {
    ...
    internal suspend fun SettingsViewModel.exportThemePreferencesJson(): JSONObject {
    ...
    internal suspend fun SettingsViewModel.restoreThemePreferencesFromBackup(themeJson: JSONObject?): Int {
    ...
    internal suspend fun SettingsViewModel.restoreNullableThemeColor(
    ...
    internal suspend fun SettingsViewModel.parseImportedReaderTypography(json: JSONObject): ImportedReaderTypographyPreset? {
    ...
    // firstString (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // firstInt (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // firstFloat (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // firstBoolean (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // optFlexibleFloat (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // normalizeImportedTextColorScheme (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // normalizeImportedTextAlignment (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    // normalizeImportedPageAnimation (fun) → SettingsViewModelHelpers.kt (Phase L 2026-08-03)

    internal suspend fun SettingsViewModel.exportAppIconJson(): JSONObject {
    ...
    internal suspend fun SettingsViewModel.restoreAppIconFromBackup(iconJson: JSONObject?): Int {
    ...
    internal fun SettingsViewModel.removeCacheDir(dirName: String): Long {
