...
/**
 * Appearance (Phase C cascade, 2026-08-02): 2 data classes for i18n
 * (AppearanceSectionText, AppearanceSettingsNavItem), 3 helpers
 * (compactToggleLabel, appLanguageLabel, settingsLibraryViewLabel),
 * 5 i18n functions (appearanceSectionText/SummaryItems/PageNavItems/PageTitle/PageDescription)
 * and the @Composable AppearanceSection. Moved from SettingsScreen.kt;
 * behavior is unchanged.
 */

/* ──── AppearanceSectionText (data class) ──── */
