...
import io.leostrange.mrcomic.engine.formats.base.LegacyFormatBookEngine
...
private class ReadiumEpubBookSession(
    ...
    override val legacyReader: io.leostrange.mrcomic.engine.formats.base.FormatReader
