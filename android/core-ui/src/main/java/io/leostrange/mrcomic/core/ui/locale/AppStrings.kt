...
val Russian = AppStrings(
    ...
    actionFile = "Файл",
    actionFolder = "Папка",
    opdsCatalog = "Онлайн-каталоги",
    opdsCatalogs = "Онлайн-каталоги",
    opdsSearch = "Поиск",
    opdsSearchPlaceholder = "Поиск…",
    opdsCatalogPickerTitle = "Каталоги книг",
    opdsCategories = "Категории",
    opdsBooks = "Книги",
    opdsLoadMore = "Загрузить ещё",
    opdsDownload = "Скачать",
    opdsRetry = "Повторить",
    opdsProjectGutenberg = "Project Gutenberg",
    opdsProjectGutenbergDescription = "Бесплатные электронные книги (общественное достояние)",
    opdsFeedbooks = "Feedbooks",
    opdsFeedbooksDescription = "Книги общественного достояния",
    opdsManyBooks = "ManyBooks",
    opdsManyBooksDescription = "Коллекция бесплатных электронных книг",
...
val English = AppStrings(
    ...
    actionFile = "File",
    actionFolder = "Folder",
    opdsCatalog = "Online catalogs",
    opdsCatalogs = "Online catalogs",
    opdsSearch = "Search",
    opdsSearchPlaceholder = "Search…",
    opdsCatalogPickerTitle = "Book catalogs",
    opdsCategories = "Categories",
    opdsBooks = "Books",
    opdsLoadMore = "Load more",
    opdsDownload = "Download",
    opdsRetry = "Retry",
    opdsProjectGutenberg = "Project Gutenberg",
    opdsProjectGutenbergDescription = "Free eBooks (public domain)",
    opdsFeedbooks = "Feedbooks",
    opdsFeedbooksDescription = "Public domain books",
    opdsManyBooks = "ManyBooks",
    opdsManyBooksDescription = "Free eBooks collection",
    readerPages = "Pages",
...
val Japanese = AppStrings(
    ...
    actionFile = "ファイル",
    actionFolder = "フォルダ",
    opdsCatalog = "オンラインカタログ",
    opdsCatalogs = "オンラインカタログ",
    opdsSearch = "検索",
    opdsSearchPlaceholder = "検索…",
    opdsCatalogPickerTitle = "ブックカタログ",
    opdsCategories = "カテゴリ",
    opdsBooks = "書籍",
    opdsLoadMore = "さらに読み込む",
    opdsDownload = "ダウンロード",
    opdsRetry = "再試行",
    opdsProjectGutenberg = "Project Gutenberg",
    opdsProjectGutenbergDescription = "無料の電子書籍（パブリックドメイン）",
    opdsFeedbooks = "Feedbooks",
    opdsFeedbooksDescription = "パブリックドメインの書籍",
    opdsManyBooks = "ManyBooks",
    opdsManyBooksDescription = "無料電子書籍コレクション",
    readerPages = "ページ",
    readerBookmark = "しおり",
...
val ChineseSimplified = AppStrings(
    ...
    opdsCatalogs = "在线目录",
    opdsSearch = "搜索",
    opdsSearchPlaceholder = "搜索…",
    opdsCatalogPickerTitle = "书籍目录",
    opdsCategories = "分类",
    opdsBooks = "书籍",
    opdsLoadMore = "加载更多",
    opdsDownload = "下载",
    opdsRetry = "重试",
    opdsProjectGutenberg = "Project Gutenberg",
    opdsProjectGutenbergDescription = "免费电子书（公版）",
    opdsFeedbooks = "Feedbooks",
    opdsFeedbooksDescription = "公版书籍",
    opdsManyBooks = "ManyBooks",
    opdsManyBooksDescription = "免费电子书合集",
    readerPages = "分页",
    readerBookmark = "书签",
...
val Korean = AppStrings(
    ...
    actionFile = "파일",
    actionFolder = "폴더",
    opdsCatalog = "온라인 카탈로그",
    opdsCatalogs = "온라인 카탈로그",
    opdsSearch = "검색",
    opdsSearchPlaceholder = "검색…",
    opdsCatalogPickerTitle = "도서 카탈로그",
    opdsCategories = "카테고리",
    opdsBooks = "도서",
    opdsLoadMore = "더 불러오기",
    opdsDownload = "다운로드",
    opdsRetry = "다시 시도",
    opdsProjectGutenberg = "Project Gutenberg",
    opdsProjectGutenbergDescription = "무료 전자책(퍼블릭 도메인)",
    opdsFeedbooks = "Feedbooks",
    opdsFeedbooksDescription = "퍼블릭 도메인 도서",
    opdsManyBooks = "ManyBooks",
    opdsManyBooksDescription = "무료 전자책 모음",
    readerPages = "페이지",
    readerBookmark = "북마크",
