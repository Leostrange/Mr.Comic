...
/**
 * Pure color-scheme mapping for the reader page palette.
 *
 * Single source of truth shared by the reader (feature-reader) and the
 * settings customization preview (feature-settings), so the preview always
 * matches the actually applied theme (BUG-UI-05). All functions are
 * stateless and free of Android/Compose dependencies.
 */
object ReaderPagePalette {
