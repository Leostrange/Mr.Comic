...
class ComicRepository @Inject constructor(
    ...
    private val formatDetector by lazy {
        ComicFormatDetector(
            ...
            archiveAccessFor = { uri ->
                ArchiveAccess(
                    stream = ArchiveStreamSource { openInputStream(uri) },
                    randomAccess = RandomAccessArchiveMaterialiser { extension ->
                        copyContentUriToTemp(uri, extension)
                    }
                )
            },
