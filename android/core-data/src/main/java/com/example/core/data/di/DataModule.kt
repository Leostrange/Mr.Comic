...
import com.example.core.data.backup.GoogleDriveBackupProvider
import com.example.core.data.backup.OneDriveBackupProvider
import dagger.Binds
...
object DataProvidersModule {
	...
	@Provides
	@Singleton
	fun provideLibraryBackupManager(
		@ApplicationContext context: Context,
		comicDao: ComicDao,
		bookmarkDao: BookmarkDao,
		settingsRepository: SettingsRepository
	): LibraryBackupManager {
		return LibraryBackupManager(context, comicDao, bookmarkDao, settingsRepository)
	}
	...
	fun provideCloudSyncManager(
		@ApplicationContext context: Context,
		libraryBackupManager: LibraryBackupManager,
		settingsRepository: SettingsRepository,
		googleDriveProvider: GoogleDriveBackupProvider,
		oneDriveProvider: OneDriveBackupProvider
	): CloudSyncManager {
		return CloudSyncManager(context, libraryBackupManager, settingsRepository, googleDriveProvider, oneDriveProvider)
	}
}
