package com.example.feature.reader.domain.preset
    ...
    ?.let { raw ->
        runCatching {
            ...
            ReaderStylePresetSnapshot(
                ...
                textAlignment = when (json.optString("textAlignment", "left").lowercase()) {
                    "justify", "left", "right", "center" -> json.optString("textAlignment", "left").lowercase()
                    else -> "left"
                },
