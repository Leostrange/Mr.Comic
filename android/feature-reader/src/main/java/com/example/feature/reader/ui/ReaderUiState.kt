...
import com.example.feature.reader.domain.enums.*
import com.example.feature.reader.domain.preset.*
...
data class ReaderUiState(
    ...
    val pageHighlights: List<com.example.core.model.TextHighlight> = emptyList(),
