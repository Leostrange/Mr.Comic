    ...
    Scaffold(topBar = { 
        ...
        Column(modifier = Modifier.padding(padding).padding(16.dp)) {
            ...
            Row(
                ...
                Text("Enable dual page mode", modifier = Modifier.weight(1f))
                androidx.compose.material3.Switch(
                    checked = enableDualPageMode,
                    onCheckedChange = viewModel::onEnableDualPageModeChanged
                )
            }
            ...
            Row(
                ...
                Text("Enable webtoon mode", modifier = Modifier.weight(1f))
                androidx.compose.material3.Switch(
                    checked = enableWebtoonMode,
                    onCheckedChange = viewModel::onEnableWebtoonModeChanged
                )
            }
        }
    }
