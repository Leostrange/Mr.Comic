...
internal data class ReaderUiText(
    ...
    val toolbarOpacityTitle: String,
    val toolbarBlurTitle: String,
    val einkPanelModeHint: String,
...
internal fun readerUiText(language: String): ReaderUiText = when (language) {
    "en" -> ReaderUiText(
        ...
        toolbarOpacityTitle = "Panel opacity",
        toolbarBlurTitle = "Panel blur",
        einkPanelModeHint = "E-Ink keeps reader panels fully opaque and disables blur.",
    ...
    "ja" -> ReaderUiText(
        ...
        toolbarOpacityTitle = "パネルの不透明度",
        toolbarBlurTitle = "パネルのブラー",
        einkPanelModeHint = "E-Ink では読書パネルは常に不透明で、ブラーは無効になります。",
        alignJustify = "両端",
        alignLeft = "左",
        alignRight = "右",
        alignCenter = "中央",
    ...
    "zh" -> ReaderUiText(
        ...
        toolbarOpacityTitle = "面板不透明度",
        toolbarBlurTitle = "面板模糊",
        einkPanelModeHint = "E-Ink 模式下阅读面板保持完全不透明，并禁用模糊。",
        alignJustify = "两端",
        alignLeft = "左对齐",
        alignRight = "右对齐",
        alignCenter = "居中",
    ...
    "ko" -> ReaderUiText(
        ...
        toolbarOpacityTitle = "패널 불투명도",
        toolbarBlurTitle = "패널 블러",
        einkPanelModeHint = "E-Ink에서는 리더 패널이 항상 불투명하며 블러가 꺼집니다.",
        alignJustify = "양쪽 맞춤",
        alignLeft = "왼쪽",
        alignRight = "오른쪽",
        alignCenter = "가운데",
        ...
        toolbarOpacityTitle = "Непрозрачность панелей",
        toolbarBlurTitle = "Блюр панелей",
        einkPanelModeHint = "В режиме E-Ink панели всегда полностью непрозрачные, а блюр отключён.",
        alignJustify = "Ширине",
        alignLeft = "Левому",
        alignRight = "Правому",
        alignCenter = "Центру",
...
internal fun readerTransportPreferenceLabel(
    preference: io.leostrange.mrcomic.core.model.TranslationTransportPreference,
    language: String
): String = when (preference) {
    io.leostrange.mrcomic.core.model.TranslationTransportPreference.AUTO -> readerUiText(language).translationAutoLabel
    io.leostrange.mrcomic.core.model.TranslationTransportPreference.OFFLINE -> when (language) {
        "en" -> "Offline"
        "ja" -> "オフライン"
        "zh" -> "离线"
        "ko" -> "오프라인"
    ...
    io.leostrange.mrcomic.core.model.TranslationTransportPreference.ONLINE -> when (language) {
        "en" -> "Online"
        "ja" -> "オンライン"
        "zh" -> "在线"
        "ko" -> "온라인"
