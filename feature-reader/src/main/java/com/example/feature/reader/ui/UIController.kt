...
class UIController {
    ...
    private var isAutoHideEnabled = false // Отключено по требованию пользователя - панели скрываются только по тапу
    ...
    fun showUI() {
        ...
        // Не запускаем автоскрытие - панели скрываются только по тапу
        // resetAutoHideTimer()
    }
     ...
     * Сбрасывает таймер автоскрытия (не используется, так как автоскрытие отключено)
     */
    fun onUserInteraction() {
        // Автоскрытие отключено - панели скрываются только по тапу
        // if (_uiVisible.value) {
        //     resetAutoHideTimer()
        // }
    }
